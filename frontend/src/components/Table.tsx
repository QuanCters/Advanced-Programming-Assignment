...
const DataTable = ({ table }: Props) => {
  ...
  return (
    <>
      ...
      {!table && (
        <div className="fw-bold w-[full] text-center mt-7">
          No data available
        </div>
      )}
      <div className="h-2" />
      <div className="d-flex flex-row gap-2 justify-content-end align-items-center mb-5 mt-2">
        <button
